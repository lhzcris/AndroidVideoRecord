...
import com.smart.android.vrecord.listener.ErrorListener;
 ...
 * =====================================
 */
public class JCameraView extends FrameLayout implements
...
//    private CameraMachine machine;
    ...
    private void initData() {
        layout_width = ViewHelperKt.getScreenWidth(mContext);
        //缩放梯度
        zoomGradient = (int) (layout_width / 16f);
        Logger.i("zoom = " + zoomGradient);
...
//        CameraInterface.getInstance().unregisterSensorManager(mContext);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Logger.i("JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
//                CameraInterface.getInstance().doOpenCamera(com.cjt2325.cameralibrary.JCameraView.this);
            }
        }.start();
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Logger.i("JCameraView SurfaceDestroyed");
